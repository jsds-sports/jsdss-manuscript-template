...
- For each Issue:
    - Create a branch on the `jsds-sports` version of the repo (as opposed to the repo on your account) and make the edits there.
...
The paper will be at `https://jsds-sports.github.io/YYYY-NNN-lastname-GHusername/` and on Project Euclid.
