---
title: "On Being a Great Athlete"
author:
...
abstract: |
  ...
  In this manuscript, we argue that greatness in sport is neither conferred by statistics nor confirmed by championships, but is instead forged at the intersection of preparation, purpose, and an unflinching commitment to something larger than oneself.
  
  Drawing on our combined experience across professional baseball and basketball, we propose a working framework of athletic greatness built on three pillars: technical mastery, the relentless refinement of physical skill; competitive grace, the ability to perform with dignity under the full weight of expectation and opposition; and consequential presence, the recognition that an athlete's influence extends well beyond the field of play and into the communities that watch, and are shaped by, what they do.
  
  We further contend that the truly great athlete does not merely respond to pressure — they redefine the conditions under which pressure operates. 
  Greatness, in this sense, is not the absence of fear or doubt, but the disciplined refusal to be governed by either.
  
  Finally, we address the obligation that accompanies excellence. 
  To be great is to accept that your platform is never entirely your own. 
  Every great performance is, in some measure, a public act — one that carries the hopes of those who could not be on the field, the court, or the stage with you.
  
  We conclude that greatness is less a destination than a daily practice, and that its truest measure is not what an athlete achieves for themselves, but what they make possible for those who come after.
keywords: [athletic excellence, sport and society, competitive performance, legacy, leadership]
...
Here are two of my favorite projects [@gibbs2022causal] and [@williams2025expected]. 

Differences between `jsdss-html` and `jsdss-pdf`: 
